...
//   });
    ...
    contract.methods.getInfo2(1).call().then(function(view){
        ...
        contract.methods.getInfo2(2).call().then(function(view){
          ...
          contract.methods.getInfo2(3).call().then(function(view){
                ...
                var template = "<tr><th>" + id + "</th><td>" + name + "</td><td>" + ppeCount + "</td></tr>"
                document.getElementById('distributionResults1').innerHTML = template;
                  
                });
           
                contract.methods.getInfo2(4).call().then(function(view){
                  ...
                  var template = "<tr><th>" + id + "</th><td>" + name + "</td><td>" + ppeCount + "</td></tr>"
                  document.getElementById('distributionResults2').innerHTML = template;
